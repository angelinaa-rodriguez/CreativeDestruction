...
par_guess = [start_alpha; start_phi; start_beta; ...
...
ub = [ 10;   2;    0.1; 0.1;  0.5;  10;  0.2;  0.2];
...
[ParEst, ErrorVal] = fmincon( ...
    ...
    par_guess, ...
    Aineq, bineq, ...     % inequality constraint λ ≥ k
...
function Ydot = econ_ode(t, Y, par, A0, g, Vdata, pi_val)
    ...
    % WAGE ODE (WITH SATURATING PRODUCTIVITY TERM)
